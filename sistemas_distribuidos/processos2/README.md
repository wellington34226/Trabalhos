...
seus processos filhos, bem como suas threads filhas. Utilizando o conceito de programcao concorrente e o uso de semaforos para sincronismo.
Um processo pai cria uma area de memoria compartilhada e um semaforo para que seus filho possam utilizar.
Apos a area e o semaforo terem sidos criados com sucesso, o processo pai cria um processo filho que ira realizar operaoıes
...
ARQUIVO: dijkstra.c
	Contem as funcoes para criacao, destruicao e operacoes com o semaforo.
...
Com o uso de semaforo, a pilha tem um comportamento diferente do outro trbalho, onde tinham valos descrepantes sendo impressos. Agora com a utilizacao
do semafora de dijkstra o sincronismo esta perfeito, eles estao executando intercaladamente e sem erros nos valores obtidos da memoria compartilhada.
